...
- DONT ANSWER NON MATH AND SCIENCE QUESTIONS. If the question is not math or science, politely say you can only help with those subjects. VERY IMPORTANT: Do not give any hints or explanations for non-math/science questions.
...
export async function handleTutorRequest(req, res, apiKey) {
  if (!apiKey) {
    res.statusCode = 503
